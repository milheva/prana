...
<body>
    ...
    <div class="header">
        <div class="header-left">
            <div class="company-name">💊 Griya Bidan Nurul</div>
            <div class="company-tagline">Apotek & Toko Obat Terpercaya</div>
    ...
    <div class="footer">
        ...
        Untuk informasi lebih lanjut, hubungi kami di admin@griyanurul.com
    </div>
</body>

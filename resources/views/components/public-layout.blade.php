...
<body class="bg-base-100 antialiased">
    <!-- Navbar -->
    <div class="navbar bg-white shadow-md sticky top-0 z-50 border-b border-base-300">
        <div class="container mx-auto">
                ...
                <div class="dropdown">
                    ...
                    <ul tabindex="0"
                        ...
                        <li><a href="{{ route('about') }}"
                                class="{{ request()->routeIs('about') ? 'active' : '' }}">Tentang</a></li>
                        <li><a href="{{ route('contact') }}"
                                class="{{ request()->routeIs('contact') ? 'active' : '' }}">Kontak</a></li>
                    </ul>
                </div>
                <a href="{{ route('home') }}" class="btn btn-ghost text-xl gap-2">
                    ...
                    <span
                        class="hidden sm:inline font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Prana
                        Medical</span>
                </a>
            </div>
            ...
            <div class="navbar-center hidden lg:flex">
                <ul class="menu menu-horizontal px-1 gap-1">
                    <li><a href="{{ route('home') }}"
                            class="{{ request()->routeIs('home') ? 'active font-bold' : '' }}">Beranda</a></li>
                    <li><a href="{{ route('products.index') }}"
                            class="{{ request()->routeIs('products.*') ? 'active font-bold' : '' }}">Produk</a></li>
                    <li><a href="{{ route('about') }}"
                            class="{{ request()->routeIs('about') ? 'active font-bold' : '' }}">Tentang</a></li>
                    <li><a href="{{ route('contact') }}"
                            class="{{ request()->routeIs('contact') ? 'active font-bold' : '' }}">Kontak</a></li>
                </ul>
            </div>
            ...
            <div class="navbar-end gap-2">
                ...
                <!-- Cart -->
                <a href="{{ route('cart.index') }}" class="btn btn-ghost btn-circle indicator">
                ...
                @auth
                    <div class="dropdown dropdown-end">
                        <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                            <div
                                class="w-10 rounded-full bg-gradient-to-br from-primary to-secondary text-primary-content flex items-center justify-center ring-2 ring-primary ring-offset-2">
                        ...
                        <ul tabindex="0"
                            ...
                            @if (auth()->user()->isAdmin())
                                <div class="divider my-1"></div>
                                <li><a href="/admin" class="text-accent">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
